...
func TestParseMessage(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			raw:       "8,111,11111,111111,ABC123,111111,111111,111111,111111,111111,35000,450,180,40.7128,-74.0060,0,1234,0,0,0,0,0",
		...
		},
		{
			...
			raw:       "4,111,11111,111111,ABC123,111111,111111,111111,111111,111111,111111,111111,111111,111111,111111,111111,111111,111111,111111,111111,111111,111111",
			timestamp: time.Now().UTC(),
			wantErr:   false,
			wantState: &types.AircraftState{
				HexIdent: "ABC123",
		...
		},
		{
			...
			raw:       "99,111,11111,111111,ABC123,111111,111111,111111,111111,111111,111111,111111,111111,111111,111111,111111,111111,111111,111111,111111,111111,111111",
			timestamp: time.Now().UTC(),
			wantErr:   true,
		},
	}
