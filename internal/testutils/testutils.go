...
func MockSBSMessage(msgType int, hexIdent string) *types.SBSMessage {
	return &types.SBSMessage{
		Raw:       fmt.Sprintf("MSG,%d,111,11111,%s,111111,111111,111111,111111,111111,111111,111111,111111,111111,111111,111111,111111,111111,111111,111111,111111,111111", msgType, hexIdent),
